...
<network-security-config xmlns:android="http://schemas.android.com/apk/res/android">
    ...
    <!-- Allows capturing post-login API calls     -->
    <!-- ========================================== -->
    <domain-config cleartextTrafficPermitted="false">
    ...
    <!-- All app endpoints remain capturable         -->
    <!-- ========================================== -->
    ...
    print(f"{C.INFO} Google OAuth: {C.G}PROTECTED{C.CC} (Login via Google will work) {C.G}✔{C.E}\n")
    print(f"{C.INFO} Other Domains: {C.Y}BYPASSABLE{C.CC} (API capture enabled) {C.G}✔{C.E}\n")
